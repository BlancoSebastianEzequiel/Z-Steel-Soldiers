...
ClientHighCaliberAmmo::ClientHighCaliberAmmo(
    ...
    path += "Units/Vehicles/high_caliber_0.png";
    x_frames.push_back(Frame(path));
    path = PATH_TO_IMAGE;
    path += "Units/Vehicles/high_caliber_90.png";
    y_frames.push_back(Frame(path));
    path = PATH_TO_IMAGE;
    path += "Units/Vehicles/high_caliber_45.png";
    xy_frames.push_back(Frame(path));
    path = PATH_TO_IMAGE;
    path += "Units/Vehicles/high_caliber_135.png";
    xy_frames.push_back(Frame(path));
