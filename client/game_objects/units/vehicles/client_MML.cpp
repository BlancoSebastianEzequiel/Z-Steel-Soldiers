...
//------------------------------------------------------------------------------
ClientMML::ClientMML(unsigned int id, unsigned int owner_id,
...
// SHOOT X
//------------------------------------------------------------------------------
void ClientMML::shoot_x(GameObject* target) {
...
// SHOOT Y
//------------------------------------------------------------------------------
void ClientMML::shoot_y(GameObject* target) {
...
// SHOOT XY
//------------------------------------------------------------------------------
void ClientMML::shoot_xy(GameObject* target) {
    unsigned int target_x = target->get_x();
    unsigned int target_y = target->get_y();
...
// GET BULLET
//------------------------------------------------------------------------------
ClientAmmo* ClientMML::get_bullet(
        unsigned int bullet_id, Unit* shooter, GameObject* target) {
    return new ClientMissileAmmo(bullet_id, shooter, target);
}
//------------------------------------------------------------------------------
