...
ClientVehicle::ClientVehicle(unsigned int id, unsigned int owner_id,
...
void ClientVehicle::move_x(unsigned int dest_x, double speed){
...
void ClientVehicle::move_y(unsigned int dest_y, double speed){
...
void ClientVehicle::move_xy(unsigned int dest_x, unsigned int dest_y,
                            double speed){
