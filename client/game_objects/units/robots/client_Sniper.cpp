...
#include "../../ammos/client_BulletAmmo.h"
#include <string>
#include <iostream>
using std::string;
using std::to_string;
ClientRobotSniper::ClientRobotSniper(unsigned int id, unsigned int owner_id,
 ...
 void ClientRobotSniper::shoot_x(GameObject* target){
...
void ClientRobotSniper::shoot_y(GameObject* target){
...
void ClientRobotSniper::shoot_xy(GameObject* target){
     unsigned int target_x = target->get_x();
     unsigned int target_y = target->get_y();
 ...
 ClientAmmo* ClientRobotSniper::get_bullet(unsigned int id,Unit* shooter,
                                          GameObject* target){
    return new ClientBulletAmmo(id,shooter,target);
 }
