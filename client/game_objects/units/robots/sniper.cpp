#include "robot.h"
#include "sniper.h"
#include "../../ammos/bulletAmmo.h"
#include <string>
#include <iostream>
using std::string;
using std::to_string;
Sniper::Sniper(unsigned int id, unsigned int owner_id,
                                     unsigned int init_pos_x,
                                     unsigned int init_pos_y):
    Robot(id, owner_id,init_pos_x,init_pos_y){
 ...
 void Sniper::shoot_x(GameObject* target){
...
void Sniper::shoot_y(GameObject* target){
...
void Sniper::shoot_xy(GameObject* target){
     unsigned int target_x = target->get_x();
     unsigned int target_y = target->get_y();
 ...
 Ammo* Sniper::get_bullet(unsigned int id,Unit* shooter,
                                          GameObject* target){
    return new BulletAmmo(id,shooter,target);
 }
