...
#include "../../ammos/client_MissileAmmo.h"
#include <string>
#include <iostream>
using std::string;
using std::to_string;
ClientRobotTough::ClientRobotTough(unsigned int id, unsigned int owner_id,
 ...
 void ClientRobotTough::shoot_x(GameObject* target) {
...
void ClientRobotTough::shoot_y(GameObject* target){
...
void ClientRobotTough::shoot_xy(GameObject* target){
     unsigned int target_x = target->get_x();
     unsigned int target_y = target->get_y();
 ...
 ClientAmmo* ClientRobotTough::get_bullet(unsigned int id, Unit* shooter,
                                          GameObject* target) {
    return new ClientMissileAmmo(id, shooter, target);
 }
