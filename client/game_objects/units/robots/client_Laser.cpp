...
// CLIENT ROBOT LASER
//------------------------------------------------------------------------------
ClientRobotLaser::ClientRobotLaser(
...
// SHOOT X
//------------------------------------------------------------------------------
void ClientRobotLaser::shoot_x(GameObject* target) {
...
// SHOOT Y
//------------------------------------------------------------------------------
void ClientRobotLaser::shoot_y(GameObject* target) {
...
// SHOOT XY
//------------------------------------------------------------------------------
void ClientRobotLaser::shoot_xy(GameObject* target) {
    unsigned int target_x = target->get_x();
    unsigned int target_y = target->get_y();
...
// GET BULLET
//------------------------------------------------------------------------------
ClientAmmo* ClientRobotLaser::get_bullet(
        unsigned int bullet_id, Unit* shooter, GameObject* target) {
    return new ClientLaserAmmo(bullet_id, shooter, target);
}
//------------------------------------------------------------------------------
