...
Robot::Robot(unsigned int id, unsigned int owner_id,
...
void Robot::move_x(unsigned int dest_x, double speed){
...
void Robot::move_y(unsigned int dest_y, double speed){
...
void Robot::move_xy(unsigned int dest_x, unsigned int dest_y,
                          double speed){
