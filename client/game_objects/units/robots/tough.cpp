...
using std::string;
using std::to_string;
Tough::Tough(unsigned int id, unsigned int owner_id,
 ...
 void Tough::shoot_x(GameObject* target) {
...
void Tough::shoot_y(GameObject* target){
...
void Tough::shoot_xy(GameObject* target){
     unsigned int target_x = target->get_x();
     unsigned int target_y = target->get_y();
 ...
 Ammo* Tough::get_bullet(unsigned int id, Unit* shooter,
                                          GameObject* target) {
    return new MissileAmmo(id, shooter, target);
 }
