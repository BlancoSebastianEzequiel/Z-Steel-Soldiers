...
// CLIENT ROBOT PYRO
//------------------------------------------------------------------------------
Pyro::Pyro(unsigned int id, unsigned int owner_id,
...
// SHOOT X
//------------------------------------------------------------------------------
void Pyro::shoot_x(GameObject* target) {
...
// SHOOT Y
//------------------------------------------------------------------------------
void Pyro::shoot_y(GameObject* target) {
...
// SHOOT XY
//------------------------------------------------------------------------------
void Pyro::shoot_xy(GameObject* target) {
    unsigned int target_x = target->get_x();
    unsigned int target_y = target->get_y();
...
// GET BULLET
//------------------------------------------------------------------------------
Ammo* Pyro::get_bullet(
        unsigned int id, Unit* shooter, GameObject* target) {
    return new PyroAmmo(id, shooter, target);
}
//------------------------------------------------------------------------------
