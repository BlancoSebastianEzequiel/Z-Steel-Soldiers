...
#include <vector>
#include <map>
#include "../territories/client_Territory.h"
...
#include "../game_objects/explosions/client_Explosion.h"
//------------------------------------------------------------------------------
...
class Map {
 private :
    ...
    ClientProxyGame& aGame;
    std::vector<Territory*> territories;
    std::map<unsigned int, Unit*> units;
    std::map<unsigned int, TerrainObject*> objects;
    std::map<unsigned int, ClientBuilding*> buildings;
    std::map<unsigned int, ClientAmmo*> bullet_map;
    std::map<unsigned int,ClientExplosion*> explosion_map;
    bool finish;
 public :
    //--------------------------------------------------------------------------
    Map(ClientProxyGame& aGame);
    //--------------------------------------------------------------------------
    ~Map();
    //--------------------------------------------------------------------------
    ...
    //--------------------------------------------------------------------------
    void handle_explosions(std::vector<ClientExplosion*>& explosions);
    //--------------------------------------------------------------------------
 private :
    //--------------------------------------------------------------------------
    void updateBuilding(const ClientProxyObject& anObject);
    //--------------------------------------------------------------------------
    void updateTerrainObject(const ClientProxyObject& anObject);
    //--------------------------------------------------------------------------
    void refreshMap();
    //--------------------------------------------------------------------------
    void updateBullet(ClientProxyMunition& aMunition);
    //--------------------------------------------------------------------------
    void createBullet(ClientProxyMunition& aMunition);
    //--------------------------------------------------------------------------
    void createUnit(ClientProxyUnit& aUnit);
    //--------------------------------------------------------------------------
    void updateUnit(ClientProxyUnit& aUnit);
    //--------------------------------------------------------------------------
    void addNode(const ClientProxyNode& aNode, std::vector<Tile*> &tiles);
    //--------------------------------------------------------------------------
    void addObject(const ClientProxyNode& aNode);
    //--------------------------------------------------------------------------
