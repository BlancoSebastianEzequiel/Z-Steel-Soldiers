...
\subsection{Servidor}
    El servidor está representado por la clase \code{ServerGame} la cual posee
    ...
    \code{ServerProxyClient} que es un hilo que se encarga de establecer la
    ...
    \subsubsection{Módulo de comunicación con el cliente}
        Este módulo está representado por la clase \code{ServerProxyClient} la
    ...
    \subsubsection{Módulo del modelo servidor}
        Este módulo está representado por la clase \code{ServerGame} la cual
        interactúa con muchos \code{ServerProxyClient}, que son hilos. Por lo
