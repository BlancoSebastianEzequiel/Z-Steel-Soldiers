...
\subsection{Servidor}
    \subsubsection{Modulo de aceptación de clientes}
        ...
        \paragraph{stop}
            ...
            Recorre todos los hilos \code{ServerProxyClient} que tiene
    ...
    \subsubsection{Modulo de comunicación con el cliente}
        \paragraph{run}
            ...
            \code{ServerProxyClient} sabe que debe responder inmediatamente al
    ...
    \subsubsection{Modulo del modelo servidor}
        \paragraph{CreateRobotGrunt}
            ...
            que esta clase, que hereda \code{ServerTask}, tiene un tiempo de
        ...
        \paragraph{MoveUntil}
            ...
            \code{MoveUnit} crea las tareas de movimiento \code{ServerTaskMove}
            donde se le pasa la clase \code{ServerNodePath}. Estas tareas se irán
        ...
        \paragraph{AttackUnit}
            ...
            \code{ServerTaskShoot} la cual al ejecutarse la misma, cuando su
